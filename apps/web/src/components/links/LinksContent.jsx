...
const profileLinks = [
  ...
  { label: 'Consultoria', href: siteRoutes.aiConsulting, internal: true },
...
const LinksContent = () => (
  <main className="min-h-screen bg-[#e9faff] px-4 py-14 text-[#142956] sm:py-20">
    <div className="mx-auto flex w-full max-w-sm flex-col items-center text-center">
      ...
      <motion.div initial={{ opacity: 0, scale: 0.9 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.1 }}>
        <ProfileIdentity featured showEducation />
      </motion.div>

      <div className="mt-10 flex items-center justify-center gap-6">
        {socialLinks.map((social) => (
          <a key={social.label} href={social.href} target="_blank" rel="noopener noreferrer" aria-label={social.label} className="text-[#142956] transition-transform hover:scale-110 hover:text-blue-600">
